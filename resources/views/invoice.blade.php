            ...
            <div class="col-12">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>
                                <i class="fa fa-globe"></i> Joyanta, Inc.
                                <small class="float-right">Date: 2/12/2019</small>
                            </h4>
                        </div>
                        <!-- /.col -->
                    </div>
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            To
                            <address>
                                <strong>Joyanta Kumer</strong><br>
                                Palashbari,Gaibandha<br>
                                Phone: (+88) 016-73975520<br>
                                Email: jsarker96@gmail.com
                            </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
